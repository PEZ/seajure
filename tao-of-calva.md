...
> Provide Visual Studio Code users with an easy to use and productive environment for Clojure and ClojureScript development.

<br>

## Editors do not matter, editor does

| Slack Channel | Members | |
| :------ | ------: | - |
| #emacs | 1357 | |
| #cursive | 1344 | |
| #vscode | 887 | (of which #calva 735)  |
| #spacemacs | 603 | |
| #vim | 685 | (of which #conjure 176) |
| #editors | 508 | (zero? activity) => true  |
| #atom | 350 | |

<br>

<img src="editors-channel.png" />
...
<div style="display: flex; flex: 2; flex-direction: column; align-items: center; position: sticky; top: 0;">
  <img src="calva-symbol.png" width="400"/>
  <img src="tao.png" width="400"/>
</div>
